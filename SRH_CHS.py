...
결과는 Plotly를 통해 시각화되며, 'results/SRH/CHS' 디렉토리에 저장됩니다.
"""
...
def visualize_results(results_TS, X_simulation, X_cycle, max_arm, beta, min_reward, max_reward):
    """CHS 데이터셋의 SRH 결과를 시각화합니다."""
    output_dir = 'results/SRH/CHS'
    ...
    fig.update_layout(
        title='Cumulative Regrets of SRH Scores for CHS Dataset',
    ...
    fig_hist.update_layout(
        title='Distribution of SRH Scores for CHS Dataset (Histogram)',
    ...
    fig_box.update_layout(
        title='Distribution of SRH Scores for CHS Dataset (Box-Plot)',
